  ...
  if (isPendingConfirmation) {
    return (
      ...
      >
        ...
        {/* CHANGE 1: "your spot is not locked" → "your place on the founding list is not confirmed until you verify your email" */}
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        {/* CHANGE 2: "Claim My Founding Spot" → "Join the Founding List" */}
        <motion.button
          type="submit"
          disabled={isLoading}
